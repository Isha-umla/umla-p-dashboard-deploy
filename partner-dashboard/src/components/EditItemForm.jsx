...
const EditItemForm = ({ setShowEditForm, editMenuItem, singleMenuItemID }) => {
  ...
  const handleCategorySelect = (e, category) => {
    ...
    setDetails({ ...details, category, isBest, itemId: singleMenuItemID });
  };
  ...
  return (
    <div className="">
      <form
        onSubmit={(e) => {
          editMenuItem(e, details);
          setShowEditForm(false);
        }}
        className=" m-4 rounded-3xl max-w-xl mx-auto"
      >
        <div className="flex relative justify-between ">
          <h1 className="text-3xl m-2 my-4">Edit Item</h1>
          <button
          ...
          <div className=" gap-3 my-4 font-medium inline-flex">
            <label className="text-[#515ADA] text-lg flex items-center justify-center gap-2 ">
              <input
                type="checkbox"
                name="isBest"
                onClick={(e) => setIsBest(e.target.value)}
